...
//************************************************************ */
  ...
  virtual MCPhysReg getYMM(unsigned ArgNo) const {
    llvm_unreachable("not implemented");
  }

  virtual MCPhysReg getXMM(unsigned ArgNo) const {
    llvm_unreachable("not implemented");
  }

  virtual MCPhysReg getZMM(unsigned ArgNo) const {
    llvm_unreachable("not implemented");
  }

  virtual MCPhysReg getGPR8(unsigned ArgNo) const {
    llvm_unreachable("not implemented");
  }

  virtual MCPhysReg getGPR64(unsigned ArgNo) const {
    llvm_unreachable("not implemented");
  }

  virtual MCPhysReg getGPR32(unsigned ArgNo) const {
    llvm_unreachable("not implemented");
  }

  virtual void createZmmMovRm(MCInst &Inst, MCPhysReg srcGPReg,MCPhysReg dstVReg)const {
    llvm_unreachable("not implemented");
  }

  virtual void createZmmMovMr(MCInst &Inst, MCPhysReg srcVReg, MCPhysReg dstGPReg) const {
    llvm_unreachable("not implemented");
  }

  virtual void createZmmAdd(MCInst &Inst, MCPhysReg DestReg, MCPhysReg SrcReg1, MCPhysReg SrcReg2)const {
    llvm_unreachable("not implemented");
  }
  virtual void createZmmAddb(MCInst &Inst, MCPhysReg DestReg, MCPhysReg SrcReg1, MCPhysReg SrcReg2)const {
    llvm_unreachable("not implemented");
  }

  virtual void createZmmSub(MCInst &Inst, MCPhysReg DestReg, MCPhysReg SrcReg1, MCPhysReg SrcReg2)const {
    llvm_unreachable("not implemented");
  }

  virtual void createZmmMul(MCInst &Inst, MCPhysReg DestReg, MCPhysReg SrcReg1, MCPhysReg SrcReg2)const {
    llvm_unreachable("not implemented");
  }

  virtual void createGPRinc(MCInst &Inst, MCPhysReg GPR, int step) const {
    llvm_unreachable("not implemented");
  }

  virtual void createLeaAsAdd(MCInst &Inst, MCPhysReg srcReg64,MCOperand expOpr, MCPhysReg dstReg64) const {
    llvm_unreachable("not implemented");
  }

  virtual void createMovqrr(MCInst &Inst, MCPhysReg DstReg, MCPhysReg SrcReg) const {
    llvm_unreachable("not implemented");
  }

  virtual bool simLoopLifter (std::vector<MCInst> &MCInsts, std::vector<std::shared_ptr< simLoop::SimLoopInst>> &simLoopInsts, std::map<int, MCOperand> &SimLoopExpOps) const {
    llvm_unreachable("not implemented");
  }

  virtual void createADD64rr(MCInst &Inst, MCPhysReg src, MCPhysReg dst) const {
    llvm_unreachable("not implemented");
  }

  virtual void createLoadFromPtrReg(MCInst &Inst, MCPhysReg ptr, MCPhysReg dst) const {
    llvm_unreachable("not implemented");
  }
  virtual void createGPRMulImm(MCInst &Inst, MCPhysReg gpr, int imm) const {
    llvm_unreachable("not implemented");
  }

  virtual void createMovImmToGPR(MCInst &Inst, MCPhysReg gpr, int imm) const {
    llvm_unreachable("not implemented");
  }

 virtual void createBroadCast32ToZmm (MCInst &Inst, MCPhysReg gpr, MCPhysReg zmm) const {
    llvm_unreachable("not implemented");
  }

  virtual void createZmmMov(MCInst &Inst, MCPhysReg src, MCPhysReg dst) const {
    llvm_unreachable("not implemented");
  }
